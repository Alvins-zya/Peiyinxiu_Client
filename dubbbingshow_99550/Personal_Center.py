...
class My_Zoom():
    ...
    def Grade(self):
        ...
        print(Follow_sum)
        print("点击等级")
        OP.find_id('com.happyteam.dubbingshow:id/source_level').click()
        time.sleep(2)
        try:
...
class My_identity():
        ...
        def VIP(self):
            ...
            try:
                ...
                try:
                    ...
                    gold = self.API.Person_senter().gold()[1]
                    if gold > 180:
                        print('钻石余额大于180，不做购买操作')
                        time.sleep(1)
                        OP.back()
                        time.sleep(1)
                        OP.back()
        ...
        #     try:
        #         '''邀请CP'''
        #         OP.find_id('com.happyteam.dubbingshow:id/invite')
        #         time.sleep(2)
        #         OP.find_id('com.happyteam.dubbingshow:id/invite').click()
        ...
        #             print(Name_list)
        #             time.sleep(1)
        #             OP.find_id('com.happyteam.dubbingshow:id/filter_edit').send_keys('此号作废')
        ...
        #             OP.find_id('com.happyteam.dubbingshow:id/editContent').send_keys('给你发送CP邀请啦！')
        #             time.sleep(2)
        #             OP.back()
        #             time.sleep(2)
        #             OP.find_id('com.happyteam.dubbingshow:id/img_cp').click()
        #             time.sleep(2)
        #             try:
        #                 OP.find_id('com.happyteam.dubbingshow:id/cancel_invite')
        #                 print('CP邀请发送成功')
        #             except:
        #                 print('CP邀请发送失败')
        #                 os.system('pause')
        ...
        #     except:
        #         time.sleep(2)
        #         OP.wait_id('com.happyteam.dubbingshow:id/svgaImageView')
        #         time.sleep(1)
        #         CP_time = OP.find_id('com.happyteam.dubbingshow:id/tv_count').text
        #         CP_count = OP.find_id('com.happyteam.dubbingshow:id/cp_count').text
        #         CP_blessing = OP.find_id('com.happyteam.dubbingshow:id/middle_zhufu_count').text
        #         print(CP_time,'CP值：',CP_count,CP_blessing)
        #         time.sleep(1)
        #         '''访客记录'''
        #         OP.find_id('com.happyteam.dubbingshow:id/tv_fang_ke').click()
        #         time.sleep(2)
        #         try:
        #             OP.find_id('com.happyteam.dubbingshow:id/textView')
        #             Visitors = OP.find_ids('com.happyteam.dubbingshow:id/remark')
        #             Visitors_list = []
        #             for i in range(len(Visitors)):
        #                 name = OP.find_ids('com.happyteam.dubbingshow:id/textView')[i].text
        #                 time  = OP.find_ids('com.happyteam.dubbingshow:id/remark')[i].text
        #                 Visitors_list.append(name)
        #                 Visitors_list.append(time)
        #                 time.sleep(0.5)
        #             print(Visitors_list)
        #             time.sleep(2)
        #             OP.find_id('com.happyteam.dubbingshow:id/userHead').click()
        ...
        #         time.sleep(2)
        #         '''奖励'''
        #         OP.find_id('com.happyteam.dubbingshow:id/tv_jiang_li').click()
        #         time.sleep(2)
        #         OP.back()
        #         time.sleep(2)
        #         '''每日任务'''
        #         OP.find_id('com.happyteam.dubbingshow:id/tv_ren_wu').click()
        #         time.sleep(1)
        #         tasks = OP.find_ids('com.happyteam.dubbingshow:id/content')
        #         task_list = []
        #         for i in range(len(tasks)):
        #             task_name = OP.find_ids('com.happyteam.dubbingshow:id/content')[i].text
        #             task_count = OP.find_ids('com.happyteam.dubbingshow:id/tv_count')[i].text
        ...
        #         time.sleep(1)
        #         '''道具'''
        #         OP.find_id('com.happyteam.dubbingshow:id/tv_dao_ju').click()
        #         time.sleep(2)
        #         OP.back()
        #         time.sleep(2)
        #         try:
        #             OP.find_id('com.happyteam.dubbingshow:id/tv_source')
        #             Source_title = OP.find_id('com.happyteam.dubbingshow:id/tv_source_title').text
        #             print(Source_title)
        #             time.sleep(1)
        ...
        #             OP.swip_up()
        #             time.sleep(2)
        #             name = OP.find_ids('com.happyteam.dubbingshow:id/username')
        #             work_list = []
        #             for i in range(len(name)):
        #                 Title = OP.find_ids('com.happyteam.dubbingshow:id/username')[i].text
        #                 gift = OP.find_ids('com.happyteam.dubbingshow:id/tv_use')[i].text
        #                 User = OP.find_ids('com.happyteam.dubbingshow:id/username')[i].text
        #                 work_list.append(Title)
        #                 work_list.append(gift)
        ...
        #             OP.wait_id('com.happyteam.dubbingshow:id/gift')
        #             try:
        #                 OP.find_id('com.happyteam.dubbinshow:id/cp')
        #             except:
        #                 print('此作品非CP作品')
        #                 os.system('pause')
        #             time.sleep(2)
        ...
        #             time.sleep(2)
        #             '''CP空间设置'''
        #             OP.find_id('com.happyteam.dubbingshow:id/btn_right').click()
        #             time.sleep(2)
        #             TouchAction(devc).press(x= 0.5*x,y= 0.83*y).release().perform()
        #             time.sleep(1)
        #             TouchAction(devc).press(x= 0.5*x , y = 0.89*y).release().perform()
        #             time.sleep(4)
        #             Photos = OP.find_ids('com.happyteam.dubbingshow:id/photo_wall_item_photo')
        #             select = random.randint(0,len(Photos)-2)
        #             OP.find_ids('com.happyteam.dubbingshow:id/photo_wall_item_photo')[select].click()
        #             time.sleep(2)
        #             OP.find_id('com.happyteam.dubbingshow:id/confirm').click()
        #             time.sleep(2)
        #         except:
...
class Notice_center():
    ...
    def Cooperation_notice(self):
        ...
        try:
            ...
            '''
            name = OP.find_xpaths('合作配音')
            if len(name)>=2:
                OP.find_xpaths('合作配音')[1].click()
                OP.wait_download('com.happyteam.dubbingshow:id/action')
                time.sleep(1)
                OP.back()
                time.sleep(1)
            ...
            try:
                ...
                OP.wait_id('com.happyteam.dubbingshow:id/record')
                OP.find_id('com.happyteam.dubbingshow:id/record').click()
                time.sleep(10)
                OP.find_id('com.happyteam.dubbingshow:id/record').click()
                time.sleep(2)
    ...
    def Chat_notices(self):
        ...
        try:
            ...
            OP.find_id('com.happyteam.dubbingshow:id/filter_edit').click()
            time.sleep(2)
            OP.find_id('com.happyteam.dubbingshow:id/filter_edit').send_keys("149046387")
            time.sleep(2)
            OP.find_id('com.happyteam.dubbingshow:id/btnSearch').click()
            try:
                OP.wait_id('com.happyteam.dubbingshow:id/userhead')
...
class Creative_center():
    ...
    def Drafts(self):
        ...
        try:
            ...
            OP.find_id('com.happyteam.dubbingshow:id/imgSource').click()
            time.sleep(2)
            OP.wait_download('com.happyteam.dubbingshow:id/play')
            OP.back()
            time.sleep(2)
            '''点击上传按钮'''
            OP.find_id('com.happyteam.dubbingshow:id/upload').click()
            ...
            if Title == banchengpin:
                ...
                try:
                    OP.find_id('com.happyteam.dubbingshow:id/tv1')
                    print('取消已选标签')
                    OP.find_id('com.happyteam.dubbingshow:id/tv1').click()
                except:
                    pass
...
class Setting():
    def App_Setting(self):
        ...
        '''推荐喜好'''
        OP.find_id('com.happyteam.dubbingshow:id/view_like').click()
        time.sleep(2)
