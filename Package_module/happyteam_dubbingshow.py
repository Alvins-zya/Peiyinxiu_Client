...
class Material():
    ...
    def Source_detail(self):
        ...
        assert (name1, name2, msg='素材视频详情界面的用户名称与空间中的用户名称校验不一致')
        time.sleep(2)
    ...
    def Source_detail_follow(self):
        ...
        try:
            ...
            check = '关注成功'
            assert (follow_toast, check, msg='关注toast内容校验不一致')
        except:
            try:
                self.driver.find_id(self.id + 'editContent')
                time.sleep(2)
    ...
    def Source_detail_types(self):
        ...
        for i in range(len(lable_name)):
            ...
            assert (name1, name, msg='素材预览界面点击的标签与标签详情界面的标签校验不一致')
            time.sleep(2)
            self.driver.find_id(self.id + 'btnBack').click()
            time.sleep(2)
        time.sleep(2)
    ...
    def Person_Zoom_change_head(self):
        ...
        try:
            ...
            try:
                toast1 = self.driver.wait_toast('//android.widget.Toast')
                check1 = '修改成功'
                assert (toast1, check1, msg='相册替换头像toast提示内容校验不一致')
            except:
...
class Circle():
    ...
    def Circle_hot_tv_jump(self):
        ...
        for i in range(len(tvs)):
            ...
            assert (tv_detail_name, tv_name, msg='标签名称校验不一致')
            time.sleep(2)
            self.driver.swip_up()
            time.sleep(2)
            self.driver.find_id(self.id + 'back').click()
    ...
    def Circle_topic_Subscribes(self):
        try:
            ...
            self.driver.wait_id(self.id + 'img_subscribe')
            tv_detail_name = self.driver.find_id(self.id + 'topic_name').text
            assert (tv_detail_name, name, msg='标签名称校验不一致')
            time.sleep(2)
            self.driver.swip_up()
            time.sleep(2)
            self.driver.find_id(self.id + 'back').click()
...
class Society():
    ...
    def Society_Edit_info(self):
        ...
        try:
            ...
            pass
        time.sleep(2)
        self.driver.find_id(soucred_id + 'society_name').send_keys(before_name)
        time.sleep(2)
    ...
    def Society_Members(self):
        ...
        #搜索用户
        self.driver.find_id(soucred_id + 'filter_edit').send_keys('15697799')
        time.sleep(2)
        self.driver.find_id(soucred_id + 'btnSearch').click()
    ...
    def test_o(self):
        try:
            ...
            assert (check1, Dissolved_content)
            self.driver.find_id(soucred_id + 'btnCancel').click()
            time.sleep(2)
        except Exception as e:
            print(e)
