...
class Dub(Dubbing):
    ...
    @unittest.skipIf(source_result_style,u'结果为False，判断是双配素材,执行此条用例')
    def test2(self):
    ...
    @unittest.skipUnless(source_result_style,u'结果为True，判断是单人素材，执行此条用例')
    def test3(self):
        #点击配音内存检查
        self.driver.find_id(soucred_id + 'dubbing_fake').click()
        time.sleep(2)
    ...
    def test4(self):
        ...
        try:
            ...
            pass
    @unittest.skipIf(source_result_style,u'结果为False，双配素材退出配音界面再进')
    def test5(self):
        #退出配音界面再进
        ...
        try:
            ...
            print('配音界面返回跳转错误')
            self.driver.Quit()
    @unittest.skipUnless(source_result_style,u'结果为True，单配素材退出再进')
    def test6(self):
        # 退出配音界面再进
        self.driver.find_id(soucred_id + 'back').click()
        time.sleep(2)
    ...
    @unittest.skipIf(source_result_style,u'结果为False，切换角色')
    def test7(self):
        #合作配音角色切换
        try:
